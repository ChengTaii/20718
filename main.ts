namespace SpriteKind {
    export const 盤子 = SpriteKind.create()
    export const 星星 = SpriteKind.create()
}
sprites.onOverlap(SpriteKind.Player, SpriteKind.星星, function (sprite, otherSprite) {
    ...
    for (let index = 0; index < 4; index++) {
        if (Math.percentChance(30)) {
            敵人 = sprites.create(img`
                ...
                . . . . . . . . . . . . . . . . 
                `, SpriteKind.星星)
            敵人.setPosition(randint(10, 150), 0)
            敵人.vy = 111
            mySprite.setStayInScreen(true)
        }
    }
